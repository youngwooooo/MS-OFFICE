...
public interface CommuMapper {
	...
	// 커뮤니티  목록
	public List<CommuVO> comList(Map<String, Object> map);
	// 커뮤니티 수
	int comTotal(Map<String, Object> map);
	// 커뮤니티 모달 조회
	...
	// 가입자 - 가입한 커뮤니티(가입승인)
	public List<ComJoinVO> comAccept (Map<String, Object> map);
	// 개설자 - 가입한 회원 리스트 (승인 / 취소)
	public List<ComJoinVO> comAllMem (Map<String, Object> map);
	// 가입자 - 가입한 커뮤니티(가입승인) 수
	public int comAcceptCount (int sbscrberEmpno);
	// 개설자 - 가입한 회원 리스트 (승인 / 취소) 수
	public int comAllMemCount (Map<String, Object> map);
	// 개설자 - 가입한 회원 변경
	...
	// 해당 커뮤니티 공지게시판 게시물 조회리스트 - 5개
	public List<ComBBVO> comNoticeList(int cmmntyNo);
	// **고칠것- 해당 커뮤니티 공지게시판 전체 리스트 (더보기)
	...
	public List<ComBBVO> comActiveList(Map<String, Object> map);
	// 해당 커뮤니티 활동게시판 게시물 수
	...
	// 공지사항에서 삭제할 파일 번호
	public int delFileNo(ComBBVO comBBVO);
	// 활동에서 삭제할 파일 번호
	public int delActFileNo(ComBBVO comBBVO);
