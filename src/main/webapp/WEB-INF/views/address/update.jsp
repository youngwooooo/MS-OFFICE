...
<div id="body">
	...
	<div class="lefr-menu-list-content">
		...
		<form id="frm" method="post" action="/address/update">
		<div class="noticeIn-step1" style="padding-left: 200px;">
			<table class="table">
				...
				<tbody>
					<tr>
						<td><input type="hidden" class="form-control" id="adresNo" name="adresNo" value="${au[0].adresNo}"></td>
					</tr>
					<tr>
						<th class="th"><span>이름</span></th>
						<td><input type="text" class="form-control" id="nm" name="nm" value="${au[0].nm}"></td>
					</tr>
					<tr>                                                                                                                
						<th class="th"><span>휴대폰</span></th>                                                                           
						<td><input type="text" class="form-control" id="telno" name="telno" value="${au[0].telno}"></td>                                             
					</tr>                                                                                                               
					<tr>                                                                                                                
						<th class="th"><span>이메일</span></th>                                                                           
						<td><input type="text" class="form-control" id="email" name="email" value="${au[0].email}"></td>                                             
					</tr>                                                                                                               
					<tr>                                                                                                                
						<th class="th"><span>주소</span></th>
						<td><input type="text" class="form-control" id="adres" name="adres" value="${au[0].adres}"></td>
					</tr>
					<tr>
						<th class="th"><span>상세 주소</span></th>
						<td><input type="text" class="form-control" id="adresDetail" name="adresDetail" value="${au[0].adresDetail}"></td>
					</tr>
					<tr>
						<th class="th"><span>회사</span></th>
						<td><input type="text" class="form-control" id="cmpny" name="cmpny" value="${au[0].cmpny}"></td>
					</tr>
					<tr>
						<th class="th"><span>직위</span></th>
						<td><input type="text" class="form-control" id="ofcps" name="ofcps" value="${au[0].ofcps}"></td>
					</tr>
					<tr>
						<th class="th"><span>회사전화</span></th>
						<td><input type="text" class="form-control" id="cmpnyTelno" name="cmpnyTelno" value="${au[0].cmpnyTelno}"></td>
					</tr>
					<tr>
						<th class="th"><span>회사주소</span></th>
						<td><input type="text" class="form-control" id="cmpnyAdres" name="cmpnyAdres" value="${au[0].cmpnyAdres}"></td>
					</tr>
				</tbody>
			</table>
		</div>
		...
		<div class="divNoticeBtn">
			<button id="btnNoticeCreate" type="submit" class="btn">완료</button>
			<button id="btnNoticePrev" type="button" class="btn" onclick="window.history.back()" >취소</button>
		</div>
		</form>
	</div>
</div>
