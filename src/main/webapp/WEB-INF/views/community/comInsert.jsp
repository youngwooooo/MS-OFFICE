...
<div id="body">
	...
	<div class="lefr-menu-list-content">
			...
			<table class="table">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<label><input type="radio" name="rcritAt" value='Y' checked> 모집중</label>
							<label><input type="radio" name="rcritAt" value='N'> 모집완료</label>
						</td>
					</tr>
		...
		<div class="divNoticeBtn">
			...
			<button id="btnNoticePrev" type="button" class="btn" onclick="location.href='/com/list'" >이전</button>
		</div>
		</form>
	</div>
</div>